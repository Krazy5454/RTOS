...
This is the source code for my RTOS class project that lasted the whole semester, slowly building upon itself. Most of what I wrote is in the src folder and some in the sound_effects folders. Below is the final report for my final lab.
